...
use crate::util::{PixelBuffer, Quadrilateral, _pt, argon2};
...
#[wasm_bindgen]
pub fn perspective_transform(_pb: JsValue, _quad: JsValue) -> JsValue {
    let pb = serde_wasm_bindgen::from_value::<PixelBuffer>(_pb).unwrap();
